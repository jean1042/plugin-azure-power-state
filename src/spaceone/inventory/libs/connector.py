...
class AzureConnector(BaseConnector):
    ...
    def set_connect(self, secret_data):
        ...
        self.monitor_client: MonitorManagementClient = MonitorManagementClient(credential=credential, subscription_id=subscription_id)
        self.sql_client : SqlManagementClient = SqlManagementClient(credential=credential, subscription_id=subscription_id)
